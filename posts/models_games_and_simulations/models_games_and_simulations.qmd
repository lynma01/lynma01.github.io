...
for _ in range(5): 
    ...
    cursor.execute("INSERT INTO Customer (FirstName, LastName, Email, Password, Address) VALUES (?, ?, ?, ?, ?)", 
...
for customer_id in range(1, 6): 
    ...
    cursor.execute("INSERT INTO 'Order' (CustomerID, OrderDate, TotalAmount, OrderStatus) VALUES (?, ?, ?, ?)", 
    ...
    for _ in range(random.randint(1, 5)): 
        ...
        cursor.execute("INSERT INTO OrderItem (OrderID, ProductID, Quantity, Price) VALUES (?, ?, ?, ?)", 
