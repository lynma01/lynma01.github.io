...
1. Acts as a "***Literate Programming***"[^literate_programming] platform, which is a programming paradigm that I've always been fascinated with.
    
2. Presents an easy way for me to create a website/blog thing.
