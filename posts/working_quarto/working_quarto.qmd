...
Depending on how it's implemented, re-using previous content is either a useful way to reinforce an idea, or a really fucking annoying way of maximizing an SEO ranking. In this case, we can easily re-use our previous writing by using Quarto's Includes[^includes]:
