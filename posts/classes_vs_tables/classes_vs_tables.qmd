...
Now, I certainly have no-one to answer to with this script. It's about ~700 lines of python code acting as a wrapper for ~2,000 lines of SQL. I can't complain too hard, given that I didn't have to write the SQL, but I can't help but feel a little let down.    
